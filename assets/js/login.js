...
document.querySelector('.form-container.sign-up form').addEventListener('submit', (e) => {
  e.preventDefault();
  const username = document.querySelector('.form-container.sign-up input[type="text"]').value;
  const email = document.querySelector('.form-container.sign-up input[type="email"]').value;
  const password = document.querySelector('.form-container.sign-up input[type="password"]').value;
